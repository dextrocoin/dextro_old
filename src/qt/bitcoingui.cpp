                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Dextro Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Dextro address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dextro: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Dextro Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dextro Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dextro"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dextro addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dextro addresses"));
    ...
    openAction->setStatusTip(tr("Open a Dextro: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dextro Core help message to get a list with possible Dextro command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Dextro Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dextro network", "", count));
}
...
{
    QString strTitle = tr("Dextro Core"); // default title
