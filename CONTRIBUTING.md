Contributing to Dextro Core
============================

The Dextro Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Dextro Core project, and is not to be
confused with overall Dextro Network Protocol consensus changes.

Whether a pull request is merged into Dextro Core rests with the project merge
...
Patches that change Dextro consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dextro consensus, it must have been
...
The project leader is the release manager for each Dextro Core release.
