...
#define SPORK_5_MAX_VALUE_DEFAULT 1000                           //1000 DXO
...
#define SPORK_13_ENABLE_SUPERBLOCKS_DEFAULT 1536693120             //ON 11-09-2018 19:12
#define SPORK_14_NEW_PROTOCOL_ENFORCEMENT_DEFAULT 1536693120        //ON 11-09-2018 19:12
...
public:
    ...
    bool SetPrivKey(std::string sDXOrivKey);
