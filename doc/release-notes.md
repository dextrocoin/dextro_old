Dextro Core version 2.2.1 is now available from:

  <https://github.com/dextro-project/dextro/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/dextro-project/dextro/issues>

Compatibility
==============

Dextro Core is extensively tested on multiple operating systems using
...
Dextro Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Dextro was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/dextro-project-translations/).
