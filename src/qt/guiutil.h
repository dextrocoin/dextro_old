...
/** Utility functions used by the Dextro Qt UI.
 */
namespace GUIUtil
{
...
// Render Dextro addresses in monospace font
...
// Parse "dextro:" URI into recipient object, return true on successful parsing
