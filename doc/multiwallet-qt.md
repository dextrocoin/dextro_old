...
In order to support loading of multiple wallets in dextro-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dextro.cpp.
...
Changes to dextro.cpp
----------------------
dextro.cpp is the entry point into dextro-qt, and as such, will require some minor modifications to provide hooks for
